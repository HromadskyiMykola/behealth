            ...
            <Container className="_containerHeader">
                <Box sx={styledBox}>
                    ...
                    <Select
                        ...
                        sx={{
                            p: 0, '& .MuiOutlinedInput-input': {p: 0},
                            boxShadow: "none",
                    ...
                    >
                        <MenuItem value={'Cherkasy'}><Typography variant="caption">Черкаси</Typography></MenuItem>
                        <MenuItem value={'Kyiv'}><Typography variant="caption">Київ</Typography></MenuItem>
                        <MenuItem value={'Termopil'}><Typography variant="caption">Тернопіль</Typography></MenuItem>
                    </Select>
                </Box>
                <Box sx={styledBox}>
                    <Box sx={styledBox}>
                        {links.map(link=>{
                                return <Link key={link} variant="body2" className="_headerNavLink">
                                            {link}
                                        </Link>
                            })}
                    </Box>
